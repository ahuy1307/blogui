...
export function BlogFeatureCard({
    ...
    return (
        <Link href={`/blog/${blog.slug}`}>
            <Card className="bg-white border-gray-200 overflow-hidden hover:border-purple-500/50 transition-all shadow-sm h-full flex flex-col cursor-pointer hover:-translate-y-4 duration-300">
