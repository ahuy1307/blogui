        ...
        <>
            {scrollPositon > 1500 && (
                <button
                    ...
                    className={`fixed ${!isBlogDetail && `bottom-[40px] md:bottom-[40px]`} ${!isBlogDetail && isMobile && `bottom-[20px]`} right-4 ${isBlogDetail && 'bottom-[90px]'} md:bottom-24 md:right-6 -rotate-45 rounded-full bg-gray-900 aspect-square p-2 opacity-100 pointer-events-auto shadow z-[48]`}
                >
                    <ScrollToTopIcon
